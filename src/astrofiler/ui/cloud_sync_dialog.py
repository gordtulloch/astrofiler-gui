...
# Import hash functions from services.cloud for duplicate detection
try:
    from ..services.cloud import _calculate_md5_hash, _get_cloud_file_hashes
except ImportError:
    # Fallback in case of import issues
    logger.warning("Could not import hash functions from services.cloud")
                ...
                try:
                    ...
                    if success:
                        ...
                        if fits_file.fitsFileSoftDelete:
                            ...
                            try:
                                from ..services.cloud import _get_gcs_client
                                client = _get_gcs_client(auth_info)
                                gcs_object_name = relative_path.replace('\\', '/')
